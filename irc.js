...
const ch=message.guild.channels.find(x=>x.name==='irc')

if(message.system){ return}
if(!ch || message.channel.id!==ch.id){ return}

if(finds(message.content,'discord.gg')){
    return
}
